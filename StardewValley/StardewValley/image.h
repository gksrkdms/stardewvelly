...
public:
	...
	// 렌더
	void render(HDC hdc, int destX, int destY, int scalar = 1);
	void render(HDC hdc, int destX, int destY,
		int sourX, int sourY, int sourWidth, int sourHeight, int scalar = 1);
	// 플롯용 스칼라 랜더
	void floatRender(HDC hdc, int destX, int destY,
	...
	// 플롯 용스칼라 애니랜더
	void floatAniRender(HDC hdc, int destX, int destY, animation* ani, float scalar = 1.0f);
